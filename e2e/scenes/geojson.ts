/**
 * GeoJSON sources in Berlin, on white: polygons with a hole, lines, points, overlapping
 * fills, line-offset and line-blur.
 */
import type { StyleSpecification } from '@maplibre/maplibre-gl-style-spec';
import type { Feature } from 'geojson';
import type { LineLayerSpecification } from 'maplibre-gl';

export function geojsonStyle(): StyleSpecification {
