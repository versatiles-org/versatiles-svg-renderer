...
- **`line-gap-width`.** A line with a gap (typically a road casing) was drawn as one solid line. It is now drawn as in MapLibre GL JS: two lines of `line-width`, one on each side of the gap. Unlike MapLibre, round caps at the ends of the line do not join the two sides. ([#53](https://github.com/versatiles-org/versatiles-svg-renderer/issues/53))
